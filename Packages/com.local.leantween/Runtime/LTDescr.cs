...
public class LTDescr
{
    ...
    public Quaternion fromQuatInternal { get; set; }
    public Quaternion fromQuat { get { return this.fromQuatInternal; } set { this.fromQuatInternal = value; } }
    public Quaternion toQuat { get; set; }
    ...
    public bool dontDestroyOnClearAll = false;
    public bool callCallbackOnDisabledObject = false;
    ...
    public bool updateInternal()
    {
        ...
        if (this.delay <= 0f && directionLocal != 0f)
        {
            if (trans == null)
                ...
                if (type == TweenAction.CALLBACK && !callCallbackOnDisabledObject)
                    return false;
	...
	*/
    ...
    public LTDescr setDontDestroyOnClearAll(bool dontDestroy)
    {
        dontDestroyOnClearAll = dontDestroy;
        return this;
    }

    public LTDescr setCallCallbackOnDisabledObject(bool call)
    {
        callCallbackOnDisabledObject = call;
        return this;
    }
}
